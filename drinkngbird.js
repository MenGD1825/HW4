...
function init() {
	...
	renderer.setClearColorHex( 0xE0FFFF,1.0 );
...
function createSupport() {
   ...
   var cubeMaterial = new THREE.MeshLambertMaterial( { color: 0xF0FFF0 } );
	// base
	var cube;
	cube = new THREE.Mesh(
...
function createBody() {
   var sphereMaterial = new THREE.MeshLambertMaterial( { color: 0xFFF0F5 } );
...
function createHead() {
   var cylinderMaterial = new THREE.MeshLambertMaterial( { color: 0xFFCCFF } );
